...
openapi-type: arm
tag: package-34123412341234
```


### Tag: package-34123412341234

These settings apply only when `--tag=package-34123412341234` is specified on the command line.

```yaml $(tag) == 'package-34123412341234'
input-file:
  - Microsoft.Cdn/stable/34123412341234/cdn.json
```
### Tag: package-2019-06

...
openapi-type: arm
tag: package-preview-2099-01
```


### Tag: package-preview-2099-01

These settings apply only when `--tag=package-preview-2099-01` is specified on the command line.

```yaml $(tag) == 'package-preview-2099-01'
input-file:
  - Microsoft.Cdn/preview/2099-01-01/cdn.json
```
### Tag: package-2019-12

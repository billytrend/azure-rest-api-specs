...
openapi-type: arm
tag: package-12341234234
```


### Tag: package-12341234234

These settings apply only when `--tag=package-12341234234` is specified on the command line.

```yaml $(tag) == 'package-12341234234'
input-file:
  - Microsoft.Cdn/stable/12341234234/cdn.json
```
### Tag: package-2019-12

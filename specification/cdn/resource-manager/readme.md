...
openapi-type: arm
tag: package-11341312313241
```


### Tag: package-11341312313241

These settings apply only when `--tag=package-11341312313241` is specified on the command line.

```yaml $(tag) == 'package-11341312313241'
input-file:
  - Microsoft.Cdn/stable/11341312313241/cdn.json
```
### Tag: package-2019-06

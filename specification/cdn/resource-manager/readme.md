...
openapi-type: arm
tag: package-134132412341234123
```


### Tag: package-134132412341234123

These settings apply only when `--tag=package-134132412341234123` is specified on the command line.

```yaml $(tag) == 'package-134132412341234123'
input-file:
  - Microsoft.Cdn/stable/134132412341234123/cdn.json
```
### Tag: package-2019-12

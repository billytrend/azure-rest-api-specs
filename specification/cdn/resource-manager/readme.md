...
openapi-type: arm
tag: package-31423412341234123412
```


### Tag: package-31423412341234123412

These settings apply only when `--tag=package-31423412341234123412` is specified on the command line.

```yaml $(tag) == 'package-31423412341234123412'
input-file:
  - Microsoft.Cdn/stable/31423412341234123412/cdn.json
```
### Tag: package-2019-12

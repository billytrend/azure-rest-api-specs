...
openapi-type: arm
tag: package-preview-341412343313
```


### Tag: package-preview-341412343313

These settings apply only when `--tag=package-preview-341412343313` is specified on the command line.

```yaml $(tag) == 'package-preview-341412343313'
input-file:
  - Microsoft.Cdn/preview/341412343313/cdn.json
```
### Tag: package-2019-12

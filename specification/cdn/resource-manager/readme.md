...
``` yaml
openapi-type: arm
tag: package-3143123241234
```


### Tag: package-3143123241234

These settings apply only when `--tag=package-3143123241234` is specified on the command line.

```yaml $(tag) == 'package-3143123241234'
input-file:
  - Microsoft.Cdn/stable/3143123241234/cdn.json
```
### Tag: package-2019-04

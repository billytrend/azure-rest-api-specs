...
openapi-type: arm
tag: package-198374102983740123
```


### Tag: package-198374102983740123

These settings apply only when `--tag=package-198374102983740123` is specified on the command line.

```yaml $(tag) == 'package-198374102983740123'
input-file:
  - Microsoft.Cdn/stable/198374102983740123/cdn.json
```
### Tag: package-2019-06

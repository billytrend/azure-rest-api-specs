...
openapi-type: arm
tag: package-98765432567890
```


### Tag: package-98765432567890

These settings apply only when `--tag=package-98765432567890` is specified on the command line.

```yaml $(tag) == 'package-98765432567890'
input-file:
  - Microsoft.Cdn/stable/98765432567890/cdn.json
```
### Tag: package-2019-12

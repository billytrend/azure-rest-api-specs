...
openapi-type: arm
tag: package-13241234113413
```


### Tag: package-13241234113413

These settings apply only when `--tag=package-13241234113413` is specified on the command line.

```yaml $(tag) == 'package-13241234113413'
input-file:
  - Microsoft.Cdn/stable/13241234113413/cdn.json
```
### Tag: package-2019-06

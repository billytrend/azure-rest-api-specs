...
openapi-type: arm
tag: package-preview-12312341231423123413
```


### Tag: package-preview-12312341231423123413

These settings apply only when `--tag=package-preview-12312341231423123413` is specified on the command line.

```yaml $(tag) == 'package-preview-12312341231423123413'
input-file:
  - Microsoft.Cdn/preview/12312341231423123413/cdn.json
```
### Tag: package-2019-06

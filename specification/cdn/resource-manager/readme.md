...
openapi-type: arm
tag: package-321431341234
```


### Tag: package-321431341234

These settings apply only when `--tag=package-321431341234` is specified on the command line.

```yaml $(tag) == 'package-321431341234'
input-file:
  - Microsoft.Cdn/stable/321431341234/cdn.json
```
### Tag: package-2019-12

...
openapi-type: arm
tag: package-preview-311324312412342134
```


### Tag: package-preview-311324312412342134

These settings apply only when `--tag=package-preview-311324312412342134` is specified on the command line.

```yaml $(tag) == 'package-preview-311324312412342134'
input-file:
  - Microsoft.Cdn/preview/311324312412342134/cdn.json
```
### Tag: package-2019-12
